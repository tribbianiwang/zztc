...
public class WalletVpAdapter extends FragmentPagerAdapter {
    ArrayList<BaseFragment> vpFragments;
    private static final String vpFragmentTitles[] = new String[]{"余额","优惠券"};
    public WalletVpAdapter(FragmentManager fm, ArrayList<BaseFragment> vpFragments) {
        super(fm);
